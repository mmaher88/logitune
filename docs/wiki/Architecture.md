...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 560" width="800" font-family="ui-monospace, 'JetBrains Mono', monospace">
  <g font-size="11" font-weight="700" letter-spacing="1.3" fill="#94a3b8">
    <rect x="0"   y="0"   width="800" height="80"  fill="#ec4899" fill-opacity="0.08" stroke="#ec4899" stroke-width="1.5"/>
    <rect x="0"   y="80"  width="800" height="80"  fill="#3b82f6" fill-opacity="0.08" stroke="#3b82f6" stroke-width="1.5"/>
    <rect x="0"   y="160" width="800" height="240" fill="#10b981" fill-opacity="0.08" stroke="#10b981" stroke-width="1.5"/>
    <rect x="0"   y="400" width="800" height="80"  fill="#8b5cf6" fill-opacity="0.08" stroke="#8b5cf6" stroke-width="1.5"/>
    <rect x="0"   y="480" width="800" height="80"  fill="#f59e0b" fill-opacity="0.08" stroke="#f59e0b" stroke-width="1.5"/>
  ...
  <g font-size="9" font-weight="700" letter-spacing="1.2" fill="#64748b">
...
> Source embedded above; edit the SVG directly in `docs/wiki/Architecture.md`.
